...
const Bio = () => {
  return (
    <div className='hidden md:flex flex-col h-screen w-full text-white font-bold items-center justify-center'>
      <div className='flex flex-col h-full w-full md:bg-second bg-no-repeat bg-contain bg-center justify-center items-center mix-blend-screen'>
        <div className='flex flex-col h-full bg-black/45 justify-center items-center'>
          <div className='h-[70%] w-[80%] lg:h-[60%] lg:w-[70%] xl:w-[55%]'>
            <h1 className='text-md font-semibold font-serif bg-black/70 mb-4'>
            ...
            <p className='text-md font-semibold font-serif bg-black/70 mb-4'>
            ...
            <p className='text-md font-semibold font-serif bg-black/70'>
